...
///
/// For each word, we can sort the letters and use that as a signature to track anagram groups.
///
/// # Example 1:
...
///
/// # Complexity:
/// - Time: O(n * klogk), where n is the number of words, and k is the average length of words.
