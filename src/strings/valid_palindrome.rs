...
fn valid_palindrome_1(s: String) -> bool {
 ...
 */
fn valid_palindrome_2(s: String) -> bool {
    let mut front = 0;
...
mod tests {
    ...
    fn test_valid_palindrome_1() {
        assert_eq!(super::valid_palindrome_1("Race Car".to_string()), true);
    }

    #[test]
    fn test_valid_palindrome_2() {
        assert_eq!(super::valid_palindrome_2("Race Car".to_string()), true);
    }
}